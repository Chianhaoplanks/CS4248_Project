...
# Tokenize and remove stopwords
	...
	#data = [word for word in tokens if word not in stopwords.words("english")]
	return text
...
if __name__ == '__main__':
	...
	print(reviews)
# Repeat for Test set
	y_test = test['Score'].apply(lambda y : simplify_score(y))
	...
	temp = []
	X_test_list = test[['Text']].values.tolist()
